...
public class VentanaSocio1 extends JFrame {
	...
	private JPanel btMisActividades;
	...
	public VentanaSocio1() {
		...
		contentPane.add(getBtMisActividades(), BorderLayout.EAST);
		actualizarHorario();
	}
	...
	private JPanel getPnHorario() {
		if (pnHorario == null) {
			...
			pnHorario.setBorder(new LineBorder(new Color(0, 0, 0)));
	...
	private JPanel getBtMisActividades() {
		if (btMisActividades == null) {
			btMisActividades = new JPanel();
			btMisActividades.setBackground(new Color(255, 255, 255));
			btMisActividades.setLayout(new BorderLayout(0, 0));
		}
		return btMisActividades;
	}
